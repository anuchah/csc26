...
public class LevelManager : MonoBehaviour
{
    ...
    public void StartLevel(Level level)
    {
        ...
        {
            case Level.Level1:
                StarManager.Instance.InitializeStarGoal(20);
                TimerManager.Instance.SetInitialRemainingTime(90);
                Loader.Load(Loader.Scene.Level1);
                break;
            case Level.Level2:
                StarManager.Instance.InitializeStarGoal(30);
                TimerManager.Instance.SetInitialRemainingTime(120);
                Loader.Load(Loader.Scene.Level2);
                break;
            case Level.Level3:
                StarManager.Instance.InitializeStarGoal(40);
                TimerManager.Instance.SetInitialRemainingTime(150);
